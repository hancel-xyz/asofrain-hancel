  ...
  if (sent) {
    return (
      <div className="bg-white border border-black/[0.08] rounded-[24px] p-6 md:p-[52px] flex flex-col items-center justify-center text-center min-h-[400px]">
        <div className="w-14 h-14 rounded-full bg-[#62AF9D] text-white flex items-center justify-center text-[24px] mb-5">✓</div>
        <h2 className="font-display font-semibold text-[26px] text-[#111111] mb-3">¡Solicitud enviada!</h2>
        <p className="text-[15px] text-[#4b5563] max-w-[420px]">
    ...
    <form onSubmit={handleSubmit} className="bg-white border border-black/[0.08] rounded-[24px] p-6 md:p-[52px]">
            ...
            <button
              ...
              className={`px-[18px] py-[11px] rounded-full text-[13px] font-semibold cursor-pointer transition-colors ${
                tipoCliente === t
                  ...
                  : "bg-white border border-black/[0.1] font-medium hover:bg-[#62AF9D]/15 text-[#111111]"
              }`}
            >
              {t}
            </button>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 mb-3.5">
          <div>
            ...
            <input name="nombre" required type="text" placeholder="Nombre completo o empresa" className="w-full px-4 py-3.5 bg-white border border-black/[0.1] rounded-xl font-sans text-[14px] text-[#111111] focus:outline-none focus:border-[#62AF9D]" />
          </div>
          <div>
            <label className="block text-[10.5px] tracking-[1px] text-[#111111]/70 font-medium mb-1.5 uppercase">LOCALIDAD</label>
            <select name="localidad" defaultValue="" className="w-full px-4 py-3.5 bg-white border border-black/[0.1] rounded-xl font-sans text-[14px] text-[#111111] focus:outline-none focus:border-[#62AF9D] appearance-none">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 mb-3.5">
          <div>
            ...
            <input name="correo" required type="email" placeholder="contacto@ejemplo.com" className="w-full px-4 py-3.5 bg-white border border-black/[0.1] rounded-xl font-sans text-[14px] text-[#111111] focus:outline-none focus:border-[#62AF9D]" />
          </div>
          <div>
            <label className="block text-[10.5px] tracking-[1px] text-[#111111]/70 font-medium mb-1.5 uppercase">TELÉFONO</label>
            <input name="telefono" type="tel" placeholder="+57" className="w-full px-4 py-3.5 bg-white border border-black/[0.1] rounded-xl font-sans text-[14px] text-[#111111] focus:outline-none focus:border-[#62AF9D]" />
          </div>
        </div>
        <div>
          ...
          <input name="direccion" type="text" placeholder="Ej. Calle 123 # 45-67" className="w-full px-4 py-3.5 bg-white border border-black/[0.1] rounded-xl font-sans text-[14px] text-[#111111] focus:outline-none focus:border-[#62AF9D]" />
        </div>
      </div>
      ...
      <div className="flex items-center justify-between gap-5 flex-wrap pt-5 border-t border-black/[0.08]">
        <label className="flex items-center gap-2.5 text-[12.5px] text-[#111111]/75 cursor-pointer">
          <input name="acepta_datos" type="checkbox" required className="w-4 h-4 accent-[#62AF9D]" />
          Acepto el tratamiento de datos personales
        </label>
        <button
          type="submit"
          disabled={isPending}
          className="px-[34px] py-[18px] bg-[#111111] text-white border-none rounded-full font-sans text-[14.5px] font-semibold cursor-pointer flex items-center gap-3 hover:bg-[#62AF9D] hover:text-[#111111] transition-colors w-full sm:w-auto justify-center disabled:opacity-60"
        >
