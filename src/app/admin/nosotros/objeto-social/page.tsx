...
import { updateNosotrosObjetoSocial } from "../actions";
...
export default async function AdminNosotrosObjetoSocialPage() {
  ...
  const section = page.secciones.objeto_social;

  return (
    <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
      <div>
        <h1 className="text-2xl font-bold tracking-tight">Nosotros - Objeto Social</h1>
        <p className="text-muted-foreground">Administra el texto del Objeto Social.</p>
      </div>

      <AdminForm action={updateNosotrosObjetoSocial} className="grid gap-6">
        <Card>
          <CardHeader>
